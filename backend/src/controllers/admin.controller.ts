...
export const getPrefeituras = async (req: Request, res: Response) => {
    try {
...
export const createPrefeitura = async (req: Request, res: Response) => {
...
export const updatePrefeitura = async (req: Request, res: Response) => {
...
export const deletePrefeitura = async (req: Request, res: Response) => {
    const id = parseInt(String(req.params.id));
    try {
